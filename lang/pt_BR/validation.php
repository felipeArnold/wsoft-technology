...
return [
    ...
    */
    ...
    'before_or_equal' => 'O campo :attribute deve ser uma data inferior ou igual a :date.',
    'between' => [
    ...
    | rápido especificar uma linha de linguagem personalizada específica para uma
