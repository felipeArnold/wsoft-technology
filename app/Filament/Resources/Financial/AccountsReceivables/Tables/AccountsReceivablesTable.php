...
use App\Filament\Resources\Financial\AccountsReceivables\Actions\MarkAccountsInstallmentAsReceivedAction;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->recordActions([
                ...
                //                    ->record(fn ($record) => $record->accounts),
                MarkAccountsInstallmentAsReceivedAction::make(),
                ...
                BulkActionGroup::make([
                    Action::make('mark_all_received')
                        ...
                        ->action(function ($records): void {
                            $records->each(fn ($record) => MarkAccountsInstallmentAsReceivedAction::execute($record));
                        }),
