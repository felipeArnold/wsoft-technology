...
final class SendAccountsPayableEmailAction extends Action
{
    protected function setUp(): void
    {
        ...
        $this
            ...
            ->modalHeading('Enviar Email - Contas a Pagar')
        ...
        return [
            Forms\Components\Select::make('email_template_id')
                ...
                ->options(fn (): array => EmailTemplate::query()
                    ->where('context', TemplateContext::AccountsPayable->value)
                ...
                ->helperText('Somente templates ativos do contexto "Contas a Pagar" são listados.'),
        ];
    }
    ...
    protected function execute(array $data): void
    {
        ...
        if (! $record) {
            Notification::make()
                ->title('Erro')
                ->body('Conta a pagar não encontrada.')
                ->danger()
                ->send();
        ...
        // Get email from person (supplier)
        ...
        if (! $template) {
            Notification::make()
                ...
                ->body('O template selecionado não é válido para Contas a Pagar.')
                ->danger()
                ->send();
        ...
        (new AnonymousNotifiable)
            ...
            ->notify(new SendEmailFromTemplateGenericNotification(
                ...
                templateContext: TemplateContext::AccountsPayable,
                modelId: $record->id,
            ));
