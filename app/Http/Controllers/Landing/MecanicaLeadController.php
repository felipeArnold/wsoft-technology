...
final class MecanicaLeadController extends Controller
{
    public function index(): View
    {
        $priceData = $this->getStripeProductData();

        return view('landing.mecanica', $priceData);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            Lead::create([
                ...
                'source' => $request->input('source', 'landing_mecanica'),
                'status' => 'novo',
            ]);

            return redirect()
                ->route('landing.mecanica')
