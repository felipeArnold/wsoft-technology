...
final class FunilariaLeadController extends Controller
{
    public function index(): View
    {
        $priceData = $this->getStripeProductData();

        return view('landing.funilaria', $priceData);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            Lead::create([
                ...
                'source' => $request->input('source', 'landing_funilaria'),
                'status' => 'novo',
            ]);

            return redirect()
                ->route('landing.funilaria')
