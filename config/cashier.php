...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This setting defines the number of days a subscription can remain in
    | "past_due" status before access is blocked. This grace period allows
    | customers to update their payment method before losing access.
    |
    */

    'past_due_grace_period' => env('CASHIER_PAST_DUE_GRACE_PERIOD', 7),
